...
function Section1() {
    return (
        <div>
            <div className="w-screen mt-10 sm:flex tracking-wide overflow-x-hidden">
                ...
                <div className="w-screen sm:w-full sm:pl-10 pl-2">
                    ...
                    <div className='flex mt-5 justify-between w-36'>
                        <span className='rounded-3xl bg-purple-700 p-2'><Instagram /></span>
